...
syntax.ml parser.mly lexer.mll typing.mli typing.ml asm.mli asm.ml kNormal.mli kNormal.ml \
elim.mli elim.ml alpha.mli alpha.ml beta.mli beta.ml assoc.mli assoc.ml \
inline.mli inline.ml constFold.mli constFold.ml  common.mli common.ml\
closure.mli closure.ml typecheck.ml asm.mli asm.ml virtual.mli virtual.ml \
sched.mli sched.ml simm.mli simm.ml regAlloc.mli regAlloc.ml emit.mli emit.ml \
main.mli main.ml
